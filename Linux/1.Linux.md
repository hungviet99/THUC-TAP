...
Phần mềm nguồn mở là phần mềm với mã nguồn được công bố và sử dụng giấy phép ngồn mở, cho phép bất cứ ai cũng có thể nghiên cứu, thay đổi và cải tiến phần mềm, phân phối phần mềm ở dạng chưa thay đổi hoặc đã thay đổi. 

### 2.Linux: 

- Tên gọi của 1 hệ điều hành máy tính 
